...
/**
 * On config isClockGame
 *
 * @param {Event} e
 */
RoomRepository.prototype.onConfigIsClockGame = function(e)
{
    var data = e.detail;
...
/**
 * On config isTeamGame
 *
 * @param {Event} e
 */
RoomRepository.prototype.onConfigIsTeamGame = function(e)
{
    var data = e.detail;
