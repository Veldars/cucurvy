...
BaseAvatar.prototype.worldRotor = false;
BaseAvatar.prototype.eraser = false;
 ...
 * @type {Number}
 */
BaseAvatar.prototype.dotSize = 60;

/**
 * Set radius
 *
 * @param {Number} size of line between two hall
 */
BaseAvatar.prototype.setDotSize = function(dotSize)
{
...
BaseAvatar.prototype.setWorldRotor = function(worldRotor)
{
    this.worldRotor = worldRotor ? true : false;
};
...
BaseAvatar.prototype.setEraser = function(eraser)
{
    this.eraser = eraser ? true : false;
};
...
BaseAvatar.prototype.clear = function()
{
    ...
    this.ghost               = BaseAvatar.prototype.ghost;
    this.worldRotor          = BaseAvatar.prototype.worldRotor;
