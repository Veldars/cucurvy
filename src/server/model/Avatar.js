 ...
 * @param {Float} dotSize
 */
Avatar.prototype.setDotSize = function(dotSize)
{
    if (dotSize < 0) {
	dotSize = 1;
    }
 ...
 * Set worldRotor
 *
 * @param {Number} worldRotor
 */
Avatar.prototype.setWorldRotor = function(worldRotor)
{
    BaseAvatar.prototype.setWorldRotor.call(this, worldRotor);
    this.emit('property', {avatar: this, property: 'worldRotor', value: this.worldRotor});
};
 ...
 * @param {Number} eraser
 */
Avatar.prototype.setEraser = function(eraser)
{
    BaseAvatar.prototype.setEraser.call(this, eraser);
    this.emit('property', {avatar: this, property: 'eraser', value: this.eraser});
};
...
Avatar.prototype.onEraser = function(pts) {
   this.emit('eraser', {points: pts, 
			 radius: this.radius
	});
};
...
Avatar.prototype.clear = function()
{
    ...
    this.printManager.stop();
    this.printManager.printDistance = 60;
    this.bodyCount = 0;
};
